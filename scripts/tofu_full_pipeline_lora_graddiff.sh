...
# Full Pipeline Script for TOFU Benchmark with LoRA - GradDiff Method
...
echo "=========================================="
echo "TOFU Full Pipeline (LoRA) - GradDiff"
echo "=========================================="
echo "Model: $MODEL"
...
if [ ! -f "$IDK_FILE" ]; then
    ...
    echo "   This script uses TOFU_QA_forget (not IDK), so IDK data is not required."
    echo ""
fi
